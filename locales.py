...
TEXT = {
    'en': {
        ...
        'bonus_instructions': "Great! To get an extra FREE sticker, share [THIS POST](YOUR_POST_URL_HERE) from our @sticky_online_store channel to your Telegram (or Instagram) story for 24 hours. Once it's live, **download the image of your story** and send it back to me here as proof!",
    ...
    'uz': {
        ...
        'ask_real_name': "✅ `{nickname}` nikneymi tasdiqlandi!\n\nEndi, iltimos, **ismingizni** kiriting (masalan, Aziz):\n\n(Bu ma'lumot stikerni olayotganingizda shaxsingizni tasdiqlash uchun ishlatiladi!)",
        ...
        'bonus_instructions': "Ajoyib! Qo'shimcha BEPUL stiker olish uchun, @sticky_online_store kanalimizdagi [USHBU POSTNI](YOUR_POST_URL_HERE) 24 soat davomida Telegram (yoki Instagram) hikoyangizda ulashing. U nashr qilingandan so'ng, **hikoyangiz rasmini yuklab oling** va menga dalil sifatida yuboring!",
